...
const FEATURES = [
  {
    icon: "bi-coin",
    label: "USDC payments",
    desc: "Lock funds in a smart contract on Base Sepolia",
  },
  {
    icon: "bi-flag-fill",
    label: "Milestone releases",
    desc: "Release payments in stages as work is completed",
  },
  {
    icon: "bi-shield-check",
    label: "Dispute protection",
    desc: "Raise disputes with evidence, protected by escrow",
  },
  {
    icon: "bi-star-fill",
    label: "On-chain reputation",
    desc: "Build trust with a verifiable reputation score",
  },
  {
    icon: "bi-person-check",
    label: "Ghost protection",
    desc: "Auto-dispute triggers if a party goes silent",
  },
  {
    icon: "bi-pencil-square",
    label: "Amendments",
    desc: "Propose contract changes with mutual consent",
  },
];
...
const STEPS = [
  {
    ...
    desc: "Define terms, deliverables, deadline and amount.",
  },
  {
    step: "02",
    icon: "bi-share",
    title: "Share the link",
    desc: "Send the contract link to the other party.",
  },
  {
    step: "03",
    icon: "bi-lock-fill",
    title: "Lock USDC",
    desc: "Both parties confirm and funds are locked on-chain.",
  },
  {
    step: "04",
    icon: "bi-check-circle-fill",
    title: "Release on approval",
    desc: "Funds release automatically when work is approved.",
  },
];
    ...
    <div className="animate-fade-in">
      ...
      <section className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="mt-6 max-w-lg text-base text-gray-400 sm:text-lg">
          Lock USDC in a smart contract. Release when both parties are
          satisfied. Built on Base with dispute protection and an on-chain
          reputation system.
        </p>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURES.map((f) => (
              <div
                key={f.label}
                className="rounded-2xl border border-white/10 bg-white/5 p-5 transition hover:border-green-500/30"
              >
      ...
      <section className="border-t border-white/5 py-16">
        <div className="mx-auto max-w-2xl rounded-2xl border border-green-500/20 bg-green-500/5 p-10 text-center">
          ...
          <p className="mt-3 text-sm text-gray-400">
            Create a free account and set up your first escrow contract in under
            2 minutes.
          </p>
          <Link
            href="/login"
