...
const config = {
  ...
  networks: {
    // ── Local Ganache (GUI, default port 7545) ──────────────────────────────
    ganache: {
      ...
      accounts: [
        ...
        "0xdbda1821b80551c9d65939329250132c444d523a5b9e83a4e59d7c93a4e40e72", // #8 ← your Party A
        "0x2a871d0798f97d79848a013d4936a73bf4cc922c825d33c1cf7073dff6d409c6", // #9 ← your Party B
      ],
    },
  },

  // Optional: silence "compiled X files" noise during deploy
  paths: {
    sources: "./contracts",
    tests: "./test",
    cache: "./cache",
